...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        if for_training:
            # update Q-function.
            tabular_q_learning(q_func, current_room_i, current_quest_i, action_index, object_index, reward, next_room_i, next_quest_i, terminal)
            pass

        if not for_training:
            # update reward
            # TODO Your code here
            epi_reward = epi_reward + reward * GAMMA ** i
            pass
